...
public class TwoSum {
	 ...
	 * Follow up question:
	 * 
	 * Find number of pairs in array in which the difference between pairs are 2
	 * 
	 * Using Setis good enough : loop through and find num-2 or num+2 is existing or not. And then divided by 2.
	 * 
	 */
