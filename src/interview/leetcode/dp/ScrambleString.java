...
public class ScrambleString {
	...
	public static void main(String[] args) {
		...
		System.out.println(s.isScramble3("rgeat", "great"));
		System.out.println(s.isScramble3("rgeata", "great"));
		System.out.println(s.isScramble3("abcd", "bdac"));
	}
    ...
    public boolean isScramble3(String s1, String s2) {
        ...
        for(int i=1; i<s1.length(); i++){
            ...
            if(isScramble(left, s2.substring(0, i)) && isScramble(right, s2.substring(i))
            || isScramble(left, s2.substring(s2.length()-i)) && isScramble(right, s2.substring(0, s2.length()-i)))
                return true;
